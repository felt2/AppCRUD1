...
public void judul() { 
Object[] judul = {"ID", "Nama Buku", "Pengarang", "Penerbit", "Tahun Terbit"};
...
rs = st.executeQuery("SELECT * FROM databuku " + where); 
while (rs.next()) {
Object[] data = {
rs.getString("id"),
...
D.setNamaBuku(jTextField2.getText());
D.setPengarang(jTextField3.getText());
D.setPenerbit(jTextField4.getText());
D.setTahunTerbit(jTextField5.getText());

try {
st = cn.createStatement();
if (edit) { 
st.executeUpdate("UPDATE databuku set " +"id='"+ jTextField1.getText() + "', "
+ "namabuku='" + jTextField2.getText() + "'," + "pengarang='" + jTextField3.getText()+ "',"
+ "penerbit='" + jTextField4.getText()+ "', "+ "tahunterbit='" + jTextField5.getText() + "' WHERE id ='" + sId + "' "); 
}else { 
st.executeUpdate("INSERT INTO databuku VALUES ('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jTextField3.getText()+"','"+jTextField4.getText()+"','"+jTextField5.getText()+"')"); 
}
tampilData("");
if (edit){ 
...
st = cn.createStatement();
st.executeUpdate("DELETE FROM databuku WHERE id='"+ tabModel.getValueAt(jTable2.getSelectedRow(), 0) + "'"); 
tampilData(""); 
refresh(); 
}
} catch (Exception e) {
